...
const Button = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-semibold rounded-md transition-all duration-180 ease-out btn-press';
  
  const variants = {
    primary: 'bg-accent-gold text-white hover:brightness-110 hover:shadow-gold',
